...
namespace AnotadorGymApp.Data.Migrations
{
    ...
    [Migration("20260128173743_InitialCleanModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.DiaEntrenamiento", b =>
                {
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.Ejercicio", b =>
                {
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.GrupoMuscular", b =>
                {
                    b.Property<int>("GrupoMuscularId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.Musculo", b =>
                {
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.RegistroEjercicio", b =>
                {
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.RegistroSerie", b =>
                {
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.RutinaDia", b =>
                {
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.RutinaEjercicio", b =>
                {
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.RutinaSemana", b =>
                {
                    b.Property<int>("SemanaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.RutinaSeries", b =>
                {
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.Rutinas", b =>
                {
                    b.Property<int>("RutinaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.Ejercicio", b =>
                {
                    b.HasOne("AnotadorGymApp.Data.Entities.GrupoMuscular", "GrupoMuscular")
                        .WithMany("Ejercicios")
                        .HasForeignKey("GrupoMuscularId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AnotadorGymApp.Data.Entities.Musculo", "MusculoPrimario")
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.RegistroEjercicio", b =>
                {
                    b.HasOne("AnotadorGymApp.Data.Entities.DiaEntrenamiento", "DiaEntrenamiento")
                        .WithMany("RegistroEjercicios")
                        .HasForeignKey("DiaEntrenamientoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AnotadorGymApp.Data.Entities.Ejercicio", "Ejercicio")
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.RegistroSerie", b =>
                {
                    b.HasOne("AnotadorGymApp.Data.Entities.RegistroEjercicio", "RegistroEjercicio")
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.RutinaDia", b =>
                {
                    b.HasOne("AnotadorGymApp.Data.Entities.RutinaSemana", "Semana")
                        .WithMany("Dias")
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.RutinaEjercicio", b =>
                {
                    b.HasOne("AnotadorGymApp.Data.Entities.RutinaDia", "Dia")
                        .WithMany("Ejercicios")
                        .HasForeignKey("DiaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.RutinaSemana", b =>
                {
                    b.HasOne("AnotadorGymApp.Data.Entities.Rutinas", "Rutina")
                        .WithMany("Semanas")
            ...
            modelBuilder.Entity("AnotadorGymApp.Data.Entities.RutinaSeries", b =>
                {
                    b.HasOne("AnotadorGymApp.Data.Entities.RutinaEjercicio", "Ejercicio")
                        .WithMany("Series")
                        .HasForeignKey("EjercicioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EjercicioMusculo", b =>
                {
                    b.HasOne("AnotadorGymApp.Data.Entities.Ejercicio", null)
                        .WithMany()
                        .HasForeignKey("EjerciciosSecundariosEjercicioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AnotadorGymApp.Data.Entities.Musculo", null)
                        .WithMany()
